      ...
      <div className={styles.grid2}>
        ...
        <Field label="Hiring for Client">
          ...
          >
            <input
              type="checkbox"
              checked={jobForm.IsClientHiring}
              onChange={(e) =>
                setJobForm((p) => ({
                  ...p,
                  IsClientHiring: e.target.checked,
                  ClientName: e.target.checked ? p.ClientName : "",
        ...
        {jobForm.IsClientHiring && (
          <Field label="Client Name" required>
            <input
              ...
              placeholder="ABC Shipping Pvt Ltd"
            />
          </Field>
        )}
        {jobForm.IsClientHiring && (
          <Field label="Show Client Name to Candidate">
            ...
            >
              <input
                type="checkbox"
                checked={jobForm.ShowClientName}
                onChange={(e) =>
                  setJobForm((p) => ({
                    ...p,
                    ShowClientName: e.target.checked,
  ...
  const handleStep1 = async () => {
    ...
    try {
      ...
      const response = await saveJobDetails({
        ...
        ShowClientName: jobForm.ShowClientName,
