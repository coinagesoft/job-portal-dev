...
const Modal = ({ title, onClose, children }) => (
  ...
  >
    ...
    >
      ...
      >
        <h5 style={{ margin: 0, color: "#122359", fontSize: "15px" }}>
          {title}
        </h5>
        <button
          onClick={onClose}
...
const EmployerApplicantsClient = () => {
  ...
  const handleDownloadCV = (applicant) => {
    ...
    setCredits((c) => c - 1);
    showToast(
      `CV downloaded for ${applicant.name}. 1 credit deducted. Balance: ${credits - 1}`,
      "info",
    );
  };

  const activeQuestionApplicant = applicantList.find(
    (a) => a.id === questionPopup,
  );
  ...
  return (
    <main className="main employer-applicants-page">
          ...
          <div className="content-page">
            ...
            >
              ...
              <span className="font-sm" style={{ color: "#92400e" }}>
                <strong>CV Download Credits:</strong> {credits} remaining — 1
                credit deducted per CV download
              </span>
              <Link
                href="/employeer/buy-credits"
                className="btn btn-border btn-xs ml-auto"
            ...
            <div className="box-filters-job">
              <div className="row align-items-center">
                ...
                <div className="col-xl-4 col-lg-4 text-lg-end mt-sm-15">
                  ...
                  <Link
                    className="btn btn-default btn-sm mr-10 mb-10"
            ...
            <div className="box-filters-job mb-20 employer-applicants-form">
              <div className="row align-items-center">
                ...
                <div className="col-xl-4 col-lg-4 text-lg-end mt-sm-15">
                  ...
                  <button
                    className="btn btn-default btn-sm mb-10"
                    type="button"
                    ...
                    <div className="card-block-info pt-20">
                      <div className="row">
                            ...
                            <div className="right-info">
                              ...
                              <div style={{ marginTop: "4px" }}>
                                ...
                                >
                                  ...
                                  {applicant.endClientName}
                                </span>
                              </div>

                              <div className="employer-applicants-tag-row mt-10">
                                <span
                                  className="employer-applicants-tag is-success"
                                  style={{
                                    display: "inline-flex",
                                    alignItems: "center",
                                    gap: "4px",
                                ...
                                {applicant.profileTags.map((tag) => (
                                  <span
                                    key={`${applicant.id}-${tag.label}`}
                                    className={`employer-applicants-tag ${tag.toneClass}`}
                                  >
                                    {tag.label}
                                  </span>
                                ))}
                              ...
                              <div style={{ marginTop: "8px" }}>
                                ...
                                {applicant.certificates.map((cert) => (
                                  <span key={cert} className="certificate-pill">
                                    {cert}
                                  </span>
                                ))}
                              </div>
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 text-lg-end mt-md-15 mt-sm-15">
                          <span
                            className={`employer-applicants-status ${applicant.statusClass}`}
                          >
                            {applicant.status}
                          </span>
                          <div
                          ...
                          >
                            ...
                            <button
                              className="btn btn-border btn-sm"
                              type="button"
                              onClick={() => setQuestionPopup(applicant.id)}
                            >
                              View Questions
                            </button>
      ...
      {questionPopup && activeQuestionApplicant && (
        <Modal
          title={`Screening Answers — ${activeQuestionApplicant.name}`}
              ...
              {activeQuestionApplicant.screeningAnswers.map((a, i) => (
                <tr key={i} style={{ borderTop: "1px solid #f3f4f6" }}>
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    <span className={`employer-applicants-tag ${a.toneClass}`}>
                      {a.value}
                    </span>
                  </td>
                </tr>
      ...
      {statusPopup && activeStatusApplicant && (
        <Modal
          title={`Change Status — ${activeStatusApplicant.name}`}
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() =>
                updateStatus(activeStatusApplicant.id, selectedStatus)
              }
            >
              Update Status
            </button>
      ...
      {mapPopup && (
        <Modal
          title={`Company Location — ${mapPopup.name}`}
          ...
          <div style={{ marginBottom: "12px" }}>
            ...
            >
              ...
              <span className="font-sm">
                Map integration — address revealed post shortlisting
              </span>
              <a
