...
const SupportTicketCenter = ({
  ...
  const ticketApi = audience === "employer" ? recruiterApi : candidateApi;
    ...
    try {
      const response =
        audience === "employer"
          ...
          : await ticketApi.getTickets(CANDIDATE_ID);
    ...
    try {
      const response =
        audience === "employer"
          ...
          : await ticketApi.getTicketSummary(CANDIDATE_ID);
    ...
    try {
      const response =
        audience === "employer"
          ...
          : await ticketApi.getThread(ticketId, CANDIDATE_ID);
    ...
    try {
      ...
      const response =
        audience === "employer"
          ...
          : await ticketApi.createTicket(CANDIDATE_ID, payload);
    ...
    try {
      const response =
        audience === "employer"
          ...
          : await ticketApi.replyTicket(ticketId, CANDIDATE_ID, {
              message: replyText,
            });
